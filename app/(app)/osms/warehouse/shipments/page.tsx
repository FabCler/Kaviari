...
import { ShipmentPlanner } from "@/components/osms/warehouse/shipment-planner";
  ...
  return (
    <div>
      ...
      {can(actor, "warehouse.ship") ? (
        <ShipmentPlanner
          lines={pending.map((line) => ({
            ...
            productCode: line.allocation.product.code,
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        ...
        <Link href="/osms/po-vs-so" className="hover:text-gold-deep hover:underline">
