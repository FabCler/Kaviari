...
export async function generateMetadata({
  ...
  const receiving = await osms.receiving.findUnique({
    where: { id },
    select: { receiptNumber: true },
  });
  return { title: `${receiving?.receiptNumber ?? "Receipt"}` };
}
        ...
        actions={
          <>
            <Button variant="outline" asChild>
              <Link href="/osms/warehouse/receiving">Back to the queue</Link>
            </Button>
            <Button variant="outline" asChild>
              <Link href={`/osms/trace/po/${receiving.poId}`}>Document trace</Link>
            </Button>
            <Button variant="gold" asChild>
              <Link href="/osms/warehouse/shipments">Ship to customers</Link>
            </Button>
          </>
        }
      />
