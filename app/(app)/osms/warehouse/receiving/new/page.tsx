...
import { GateChecklist } from "@/components/osms/gate-checklist";
import { NoAccess } from "@/components/osms/no-access";
import { ReceiveForm } from "@/components/osms/warehouse/receive-form";
...
export default async function NewReceivingPage({
  ...
  if (!poId) redirect("/osms/warehouse/receiving");
