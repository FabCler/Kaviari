...
import { poVsSo } from "@/lib/osms/queries";
import { COMPARISON_LABELS, type ComparisonStatus } from "@/lib/osms/domain";
...
import type { StatusTone } from "@/lib/osms/status";

export const dynamic = "force-dynamic";
export const metadata = { title: "PO vs SO" };
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <ExportButton href="/api/osms/exports/po-vs-so" />
        }
      />
