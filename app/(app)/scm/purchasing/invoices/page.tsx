...
export const metadata = { title: "Supplier invoices — Kaviari Cellar" };
...
export default async function InvoicesPage() {
  ...
  const invoices = await prisma.scmInvoice.findMany({
      ...
      <PageHeader
        ...
        actions={
          <Button variant="gold" asChild>
            <Link href="/scm/import">Upload an invoice</Link>
          </Button>
        }
      />
                    ...
                    return (
                      <TableRow key={invoice.id}>
                        ...
                        <TableCell className="text-sm">
                          {invoice.po ? (
                            <Link
                              href={`/scm/trace/po/${invoice.poId}`}
