...
import { ReconBoard } from "@/components/scm/purchasing/recon-board";

export const dynamic = "force-dynamic";
export const metadata = { title: "PO vs Invoice — Kaviari Cellar" };
...
export default async function PoInvoicePage({
  ...
  const recons = await prisma.scmPoInvoiceRecon.findMany({
    where: {
