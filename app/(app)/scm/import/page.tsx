...
import { ImportView } from "@/components/scm/import/import-view";

export const dynamic = "force-dynamic";
export const metadata = { title: "Import files — Kaviari Cellar" };
 ...
 */
export default async function ScmImportPage() {
  const actor = (await currentActor())!;

  const [batches, purchaseOrders] = await Promise.all([
    prisma.scmImportBatch.findMany({
