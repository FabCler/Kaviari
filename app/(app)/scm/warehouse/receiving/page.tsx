...
export const metadata = { title: "Receiving — Kaviari Cellar" };
                    ...
                    return (
                      <TableRow key={po.id}>
                        ...
                        <TableCell className="text-sm">
                          {receipt ? (
                            <Link
                              href={`/scm/warehouse/receiving/${receipt.id}`}
                        ...
                        <TableCell>
                          {receipt ? (
                            <Button size="sm" variant="outline" asChild>
                              <Link href={`/scm/warehouse/receiving/${receipt.id}`}>
                                Open
                              </Link>
                            </Button>
                          ) : (
                            <Button
                              ...
                              asChild
                            >
                              <Link href={`/scm/warehouse/receiving/new?po=${po.id}`}>
