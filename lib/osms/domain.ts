/**
 * Vocabulary of OSMS: departments, document statuses,
...
export type PoStatus = (typeof SCM_PO_STATUSES)[number];
 ...
 * variance. Overridable by admins in Settings (`qtyTolerancePct`,
 * `priceTolerancePct`).
 */
